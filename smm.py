...
while 1:
 ...
 |_|  \_\__,_|\__\___|
    ...
    try:
        ...
        system("cls||clear")
        print(Fore.LIGHTRED_EX + "Hatalı giriş yaptın. Tekrar deneyin.")
        sleep(3)
        continue
    if menu == 1:
        system("cls||clear")
        ...
        if tel_no == "":
            ...
            try:
                ...
                system("cls||clear")
                print(Fore.LIGHTRED_EX + "Hatalı dosya dizini. Tekrar deneyin.")
                sleep(3)
                continue
        else:
            try:
                ...
                system("cls||clear")
                print(Fore.LIGHTRED_EX + "Hatalı telefon numarası. Tekrar deneyin.") 
                sleep(3)
                continue
        system("cls||clear")
        try:
            print(Fore.LIGHTYELLOW_EX + "Mail adresi (Girilmeyecekse 'enter' tuşuna basın): "+ Fore.LIGHTGREEN_EX, end="")
            mail = input()
        ...
        try:
            ...
            dur.set()
            system("cls||clear")
            print("\nCtrl+C tuş kombinasyonu algılandı. Panele dönülüyor...")
            sleep(2)
